"""
去除采集卡采集到的4个最小值，给剩下的值取平均当作测到的电压
修改输入的tdms文件位置的代码在第21行，修改图像的输出位置的代码在178行
"""
import pandas as pd
import numpy as np
...
try:
    ...
    # 读取TDMS文件
    input_file = r"D:\桌面\毕设\data[16,16]\16.tdms"
...
# 保存到新的Excel文件
output_file = r"D:\桌面\毕设\data[16,16]\数据16的处理.xlsx"
